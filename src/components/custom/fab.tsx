    ...
    const UserCard = () => {
        return (
            <div className='w-full h-14 flex justify-start items-center border-black'>
                ...
                <button className='w-full h-full flex justify-center items-center border-y-2 border-black border-l' onClick={() => open()}>
    ...
    <div className='md:hidden'>
        ...
        <DrawerContent>
            ...
            <div className='w-full h-14 flex flex-cols justify-start items-center bg-white divide-x-2 divide-black'>
                <button className='w-2/3 h-14 flex flex-cols justify-center items-center gap-x-4'>
                        <SiGithub size={32} />
                        Source
                </button>
                <div className='w-1/3 h-14 divide-x-2 divide-black flex flex-cols justify-center items-center'>
